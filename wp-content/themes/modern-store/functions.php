...
function ct_modern_store_register_required_plugins()
{
    $plugins = array(
    ...
    $config = array(
        ...
        'message'      => '',
        'strings'      => array(
            'page_title'                      => __('Install Recommended Plugins', 'modern-store'),
            'menu_title'                      => __('Recommended Plugins', 'modern-store'),
            'notice_can_install_recommended'     => _n_noop(
                'The makers of the Modern Store theme now recommend installing Independent Analytics, their new plugin for visitor tracking: %1$s.',
                'The makers of the Modern Store theme now recommend installing Independent Analytics, their new plugin for visitor tracking: %1$s.',
                'modern-store'
            ),
        )
...
add_action('tgmpa_register', 'ct_modern_store_register_required_plugins');
...
if (! function_exists('ct_modern_store_output_header_promo_styles')) {
    function ct_modern_store_output_header_promo_styles()
    {
        ...
        foreach ($slides as $slide) {
            ...
            if (ct_modern_store_header_promo_output_rules($slide) == false) {
                continue;
            }
...
if (! function_exists('ct_modern_store_homepage_categories')) {
    function ct_modern_store_homepage_categories($setting)
    {
        ...
        if ($setting == 'modern_store_homepage_categories') {
            ...
            if (get_theme_mod('homepage_custom_categories') != 'yes') {
                return;
            }
...
if (! function_exists('ct_modern_store_homepage_remove_add_to_cart')) {
    ...
    {
        if (get_theme_mod('show_add_to_cart') != 'yes') {
