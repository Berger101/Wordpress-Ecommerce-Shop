...
function ct_modern_store_add_customizer_content( $wp_customize ) {
	...
	// section
	$wp_customize->add_section( 'modern_store_homepage_settings', array(
		'title'    => __( 'Settings', 'modern-store' ),
		'panel' 	 => 'ct_modern_store_homepage_panel',
		'priority' => 0
	) );
	// Display - setting
	$wp_customize->add_setting( 'homepage_editor_content', array(
		'default'           => 'no',
		'sanitize_callback' => 'ct_modern_store_sanitize_homepage_editor_content_setting'
	) );
	// Display - control
	$wp_customize->add_control( 'homepage_editor_content', array(
		'label'    => __( 'Display content from the page editor?', 'modern-store' ),
		'section'  => 'modern_store_homepage_settings',
		'settings' => 'homepage_editor_content',
		'type'     => 'radio',
		'choices'  => array(
			'no'  	=> __( 'No', 'modern-store' ),
			'above' => __( 'Above everything else', 'modern-store' ),
			'below' => __( 'Below everything else', 'modern-store' ),
		)
	) );
	...
	// setting - byline - author
	$wp_customize->add_setting( 'byline_author', array(
		'default'           => 'yes',
		'sanitize_callback' => 'ct_modern_store_sanitize_yes_no_settings'
	) );
	// control - byline - author
	$wp_customize->add_control( 'byline_author', array(
		'label'    => __( 'Display author in the post byline?', 'modern-store' ),
		'section'  => 'modern_store_blog',
		'settings' => 'byline_author',
		'type'     => 'radio',
		'choices'  => array(
			'yes' => __( 'Yes', 'modern-store' ),
			'no'  => __( 'No', 'modern-store' )
	...
	// setting - byline - date
	$wp_customize->add_setting( 'byline_date', array(
		'default'           => 'yes',
		'sanitize_callback' => 'ct_modern_store_sanitize_yes_no_settings'
	) );
	// control - byline - date
	$wp_customize->add_control( 'byline_date', array(
		'label'    => __( 'Display date in the post byline?', 'modern-store' ),
		'section'  => 'modern_store_blog',
		'settings' => 'byline_date',
		'type'     => 'radio',
		'choices'  => array(
			'yes' => __( 'Yes', 'modern-store' ),
			'no'  => __( 'No', 'modern-store' )
	...
	// setting - show the "Add to Cart" button
	$wp_customize->add_setting( 'show_add_to_cart', array(
		'default'           => 'no',
		'sanitize_callback' => 'ct_modern_store_sanitize_yes_no_settings'
	) );
	// control - show the "Add to Cart" button
	$wp_customize->add_control( 'show_add_to_cart', array(
		'label'    => __( 'Show the "Add to Cart" buttons?', 'modern-store' ),
		'section'  => 'ct_modern_store_additional_options',
...
function ct_modern_store_sanitize_homepage_editor_content_setting( $input ) {
